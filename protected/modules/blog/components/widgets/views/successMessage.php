    ...
    <tr>
        <td>
            <table bgcolor="#ffffcc" border="0" cellpadding="4" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        <td colspan="3" align="center"><b>Successfull registration</b></td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo Yii::app()->params['http_addr']; ?>images/checkmark_big.gif" border="align=absmiddle" width="40" height="40" ></td>
