<script>
    ...
    function getMessage(){        
        jQuery.post(
            '<?php echo Yii::app()->params['http_addr']; ?>chat/test/getChatMessage',
            {
                'filename' : "d:\\xampp\\htdocs\\psychic_contact_com_new\\new\\public_html\\advanced\\data\\countries.txt"
            },
            function(json){
                Chat.sendMessage(json[cnt]);
                cnt++;
            },
            'json'
        );
