...
function checkForUpdates()
	{
		runAjax({
			url     : "<?php echo Yii::app()->params['http_addr']; ?>chat/test/testCheck",
...
var checkForUpdatesOnSuccess = function(json)
{
        if(json != null)
        {
                ...
                {
                        window.location.href = "<?php echo Yii::app()->params['http_addr']; ?>chat/test/startChatting?client_id=9615&request_id="+json.request_id+"&reader_id=19310";
                }
        }
}
</SCRIPT>
