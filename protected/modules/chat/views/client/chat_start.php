...
<table border="0" cellpadding="0" cellspacing="0" width="550">
    <tbody>
        <tr>
            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxldevelop1.gif" width="25" height="31" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="25" height="31"></td>
            <td width="100%">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxdevelop1.gif" valign="top" nowrap="nowrap">
                                <table background="" border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr height="11">
                                            <td width="1"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="1" height="11"></td>
                                        </tr>
                                        <tr>
                            ...
                            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxudevelop1.gif" width="18" height="31" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="18" height="31"></td>
                            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxuu1.gif" width="100%" height="31" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" height="31"></td>
                        </tr>
                </table>
            </td>
            <td width=14 height=31 nowrap background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxrdevelop1.gif"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width=14 height=31></td>
            <td nowrap width=1 ><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width=1></td>
            <td width=1 nowrap><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" ></td>
        </tr>
        <tr>
            <td width=25 nowrap background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxl1.gif"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width=25></td>
            <td bgcolor="#F7F7F7" style="color: black;">
                ...
                <?php else: ?>
                <?php echo CHtml::beginForm(ChatHelper::moduleUrl().'/client/chatRequest', 'post', array('onSubmit' => 'return check();')); ?>
            ...
            <td nowrap width=14 nowrap background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxright1.gif"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width=14></td>
            <td nowrap width=1 ><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width=1></td>
        </tr>
        <tr>
            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxlddevelop1.gif" width="15" height="12" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="15" height="12"></td>
            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxdddevelop1.gif" width="100%" height="12" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" height="12"></td>
            <td background="<?php echo ChatHelper::baseUrl(); ?>images/index_files/boxrddevelop1.gif" width="14" height="12" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="14" height="12"></td>
            <td width="1" height="12" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="1" height="12"></td>
            <td width="1" height="12" nowrap="nowrap"><img src="<?php echo ChatHelper::baseUrl(); ?>images/transp.gif" width="1" height="12"></td>
        </tr>
    </tbody>
</table>
