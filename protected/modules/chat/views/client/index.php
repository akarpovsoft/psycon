<body onload="pageInit()">	
    <div id="main" class="container">
        ...
        <div id="footer">
            ...
            <textarea cols="" rows="" name="message" onkeydown="if(!Chat.typingInterval && !Chat.typing && event.keyCode != 13) Chat.typingInterval = setTimeout('Chat.sendTypingMsg()', 3000); if(event.keyCode == 13){ return false;}" id="message" class="inputField"></textarea>
