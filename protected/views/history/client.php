...
<a href="<?php echo Yii::app()->params['http_addr']; ?>emailreadings/list">E-Readings History</a>
<br><br>
</center>
...
<SCRIPT LANGUAGE="JavaScript">
    ...
    {
        w2 = window.open("<?php echo Yii::app()->params['http_addr']; ?>history/openLog?session_id="+fileopen+"&reader_id="+reader_id,"Logs","width=500,height=500,toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=1");
        window.w2.focus();
    }
    ...
    function deleteLog(session)
    {
        ...
        var url = "<?php echo Yii::app()->params['http_addr'].'history/del' ?>";
        alert(url);
    ...
    <tbody>
        <tr>
            ...
            <td width="300" align="right">
                <b><a href="<?php echo Yii::app()->params['http_addr']; ?>history/download">Download transcripts <font color="red">(NEW!)</font></a></b>
            </td>
        </tr>
    </tbody>
</table>
