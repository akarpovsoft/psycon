...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input class="InputBoxFront" type="password" size="40" maxlength="50" name="password" value="<?php echo $client->password ?>">
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td nowrap="nowrap">
                <span class="TextSmall">
                    Your site design theme
                </span>
            </td>
            <td>
                 <select name="theme">
                     <option value="0" <?php echo ($client->design_theme == '0') ? 'selected' : '' ?>>New design</option>
                     <option value="1" <?php echo ($client->design_theme == '1') ? 'selected' : '' ?>>Old design</option>
                 </select>
            </td>
        </tr>
        <tr>
