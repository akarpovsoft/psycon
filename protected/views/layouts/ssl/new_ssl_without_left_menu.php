...
<div class="page">	
	<div class="top_header_bar">
        ...
        <div class="social_icons">
        	<a href='#' style="margin: 0 0 0 40px;"><img src="<?php echo Yii::app()->params['ssl_addr']; ?>new_images/facebook.jpg"></a>
			<a href='#'><img src="<?php echo Yii::app()->params['ssl_addr']; ?>new_images/twitter.jpg"></a>
