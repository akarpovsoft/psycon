...
<BODY text=#000000 vLink=#333366 aLink=#333366 link=#333366 bgColor="#BF9DBF" background="<?php echo Yii::app()->params['ssl_addr']; ?>images/bg.gif" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0"
         ...
         onload="init()">        <table width="838" border="0" cellspacing="0" cellpadding="0" align="center" style="height:100% ">
  <tr>
    <td valign="top" height="343px" align='center' bgcolor="#ffffff">
        <table cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo Yii::app()->params['http_addr']; ?>site/ourreaders?oo=1" style="text-decoration: none;">
                        <img border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/source/PsychicOnline.jpg">
                    </a>
                </td>
                <td>
                    <a href="<?php echo Yii::app()->params['http_addr']; ?>site/chatreadings" style="text-decoration: none;">
                        <img border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/source/ChatReadings.jpg">
                    </a>
                </td>
                <td>
                   <a href="<?php echo Yii::app()->params['http_addr']; ?>site/webphone" style="text-decoration: none;">
                        <img border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/source/PhoneReadings.jpg">
                    </a>
                </td>
                <td>
                    <a href="<?php echo Yii::app()->params['ssl_addr']; ?>site/emailreadings" style="text-decoration: none;">
                        <img border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/source/EmailReadings.jpg">
                    </a>
                </td>
                <td>
                    <a href="<?php echo Yii::app()->params['http_addr']; ?>site/ourprices" style="text-decoration: none;">
                        <img border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/source/OurPrices.jpg">
                    </a>
                </td>
            </tr>
        </table>
  ...
  <center>
      <img border="0" alt="" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/flags/uk.gif"/><br />
  </center>
  <?php echo $content; ?>
