...
<table border="0" cellspacing="0">
    ...
    <tr>
        <td align='center'  height='10px'>  <?php echo Yii::t('lang', '56_Stebbins_Ct'); ?> </td>
    </tr>
    <tr>
        <td align='center'  height='10px'>  <?php echo Yii::t('lang', 'DFS_FL_32433'); ?> </td>
    </tr>
    <tr>
        <td align='center'  height='10px'>  <?php echo Yii::t('lang', '1_800_337_8465'); ?> </td>
    </tr>
    <tr>
        <td align='center'  height='10px'> <?php echo Yii::t('lang', 'javachat@psychic-contact.com'); ?> </td>
    </tr>
</table>
<?php echo CHtml::beginForm(); ?>
    ...
    <table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" id="AutoNumber1">
        ...
        <tr>
            <td><?php echo Yii::t('lang', 'Your_Username'); ?> 
        ...
        <tr>
            <td> <?php echo Yii::t('lang', 'Message'); ?>:</td>
            <td>
                <?php echo CHtml::activeTextArea($model,'body', array('rows' => '10', 'cols' => '25')) ?>
            </td>
        </tr>
        <?php if(isset($guest)): ?>
            <tr>
