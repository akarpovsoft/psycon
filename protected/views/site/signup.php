...
<table border="0" width="480">
    <tbody>
        ...
        <tr>
            ...
            <td nowrap="nowrap">
                <span class="TextSmall">
                        <?php echo Yii::t('lang', 'Confirm_Email'); ?>:&nbsp;&nbsp;
                </span>
            </td>
            <td>
                    <?php echo CHtml::activeTextField($mod, 'email_confirm', array('class' => 'InputBoxFront', 'size' => 40, 'maxlength' => 50)); ?>
            </td>
        </tr>
        <?php if($mod->getError('email_confirm')): ?>
        <tr>
            <td colspan="3">
                <?php $this->widget('InputError', array('errors' => $mod->getError('email_confirm'))); ?>
            </td>
        </tr>
        <?php endif; ?>
        <tr>
        ...
        <tr>
            ...
            <td valign="top">
                <span class="TextSmall">
                        <?php echo Yii::t('lang', 'register_msg_21'); ?><br><br>
                </span>
            </td>
            <td valign="top">
                    <?php echo CHtml::activeTextField($mod, 'website', array('class' => 'InputBoxFront')); ?>
            </td>
        </tr>
        <?php if($mod->getError('website')): ?>
        <tr>
            <td colspan="3">
                <?php $this->widget('InputError', array('errors' => $mod->getError('website'))); ?>
            </td>
        </tr>
        <?php endif; ?>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4" align="left" width="100%">
                <font color="#ff0000"><b><?php echo Yii::t('lang', 'register_msg_26_4'); ?><br>
                    </b>
                </font>
                <p class="MsoNormal"><span style="color: rgb(191, 0, 191);"><font color="#ff0000"><b>"<?php echo Yii::t('lang', 'register_msg_26_5'); ?>"<br>
                            </b></font></span>
                    <font color="#ff0000"><b>&nbsp;<em><span style="color: rgb(64, 64, 255);"><a href="<?php echo Yii::app()->params['site_domain']; ?>/chat/popup.php?action=fb2" target="_blank"><b><?php echo Yii::t('lang', 'register_msg_26_6'); ?></b></a></span><a href="<?php echo Yii::app()->params['site_domain']; ?>/chat/popup.php?action=fb2" target="_blank"><b></b></a></em><a href="<?php echo Yii::app()->params['site_domain']; ?>/chat/popup.php?action=fb2" target="_blank"><b></b></a></b></font><b><b><br>
            ...
            <td nowrap="nowrap">
                    ...
                    if(isset($no_freebie)) {
                        ...
                        foreach($tariffs as $key => $value) {
                            if($key == 1) continue;
                            // This tariff is not for signup
                            if(isset($value['repeaterOnly']) && !empty($value['repeaterOnly'])) continue;
        ...
        <tr>
            ...
            <td colspan="4" width="100%">                
                ...
                &nbsp;
                &nbsp;
                <input type="submit" name="register" id="register" value="Register" <?php echo ($mod->terms != 1) ? 'disabled="disabled"' : ''?>><input type="reset" name="reset" value="Cancel">
                <?php else: ?>
                <input type="submit" name="register" id="register" value="Register"><input type="reset" name="reset" value="Cancel">
                <?php endif; ?>
            </td>
        </tr>
    </tbody>
