                        ...
                        <tr>
                            <td>
                                <table bgcolor="#ffffcc" border="0" cellpadding="4" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                            <td colspan="3" align="center"><b><?php echo Yii::t('lang','Payment_success') ?></b></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="pperrorbold" width="100%">
                                                    <?php echo Yii::t('lang', 'Payment_success_chat') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" align="center">
                                                <b>
                                                    <a href="<?php echo Yii::app()->params['http_addr']; ?>users/mainmenu" style="text-decoration: none">
                                                        Your account
                                                    </a>
                                                </b>
                                            </td>
        ...
        <tr>
            <td>
                <table bgcolor="#ffffcc" border="0" cellpadding="4" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            <td colspan="3" align="center"><b><?php echo Yii::t('lang','Payment_errors') ?></b></td>
                        </tr>
                        <tr>
                        ...
                        <td align=left>
                            <table border=0>
                                <tr>
                                    ...
                                    <td>
                                        <select name="tariff">
                                                <?php foreach($tariffs['chat_opt'] as $key => $tariff): ?>
                                            <option value="<?php echo $key; ?>" <?php if(isset($tariff['style'])) echo 'style="'.$tariff['style'].'"'; ?>>
                                                $<?php echo $tariff['amount']; ?> <?php echo $tariff['title']; ?></option>
                                                <?php endforeach; ?>
                                        </select>
