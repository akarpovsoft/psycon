...
<tr>
    <td bgcolor="#F7F7F7" nowrap>
        ...
        <?php if ($layout == 2): ?>
            <?php foreach ($links as $item): ?>
                &nbsp;&nbsp;&nbsp; <img width="3" height="6" border="0" alt="" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/pointer1.gif"/>&nbsp;
        ...
        <?php foreach($leftArt as $thread): ?>
            &nbsp;&nbsp;&nbsp; <img src="<?php echo Yii::app()->params['ssl_addr']; ?>images/pointer1.gif" width="3" height="6" alt="" border=0>
                <a href="<?php echo Yii::app()->params['http_addr'] ?>article/<?php echo $thread->alias; ?>" class="navigation">&nbsp; <?php echo $thread->title; ?></a><br>
        <?php endforeach; ?>
        <?php endif; ?>
        <br/>
     </td>
    ...
    <td align="center">
        ...
        <tr>
           <td align="center">
                ...
                <img alt="" border="0" src="<?php echo Yii::app()->params['ssl_addr']; ?>images/paypal.jpg" height="40">
    ...
    <td align="center">
        <table border="1" borderwidth="0" bordercolor="#660099" cellspacing="0" cellpadding="0" width="95%">
            <tr>
                <td align="center">
                <br />
                <a href="<?php echo Yii::app()->params['http_addr']; ?>profile/readerview?id=18032" style="text-decoration:none">
                <?php echo Yii::t('lang', 'Special_E_mail_Reading'); ?> - $10.00
                </a>
                <br />
                <br />
                </td>
...
<br />
&nbsp;&nbsp;&nbsp; &nbsp;
<a href="<?php echo Yii::app()->params['http_addr']; ?>blog/articles" target="_top"  class="navigation"><?php echo Yii::t('lang', 'Metaphysical_Articles'); ?></a><br>
&nbsp;&nbsp;&nbsp; &nbsp;
