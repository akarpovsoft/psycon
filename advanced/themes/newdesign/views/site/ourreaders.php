...
{
    var url = "/advanced/site/reloadReadersList?type=OurReaders<?php echo ($cat) ? "&cat=".$cat : ''; ?>&online=0<?php echo (!$_POST['cat'] && !$_POST['keyword']) ? '&count=18' : ''; ?>&title=no_title<?php echo ($keyword) ? "&keyword=".$keyword : ''; ?>";
...
<br>
<?php if(!$_POST['cat'] && !$_POST['keyword']): ?>
<a href="<?php echo Yii::app()->params['http_addr']; ?>site/moreReaders" style="font-size: 16px;"><img src="<?php echo Yii::app()->params['http_addr']; ?>images/more-reader-button.jpg"></a>
<?php endif; ?>
</center>