...
function displayReader($reader_href, $reader)
{
	...
	$reader_title="<a href='".$reader_href."' target='main'>".ucwords($reader['login'])."</a>";
	DrawBoxTitle($reader_title, true, 160,'');
	echo "<a href='".$reader_href."' target='main'><img src=\"".getStatusImage($reader['status'], $reader['rr_record_id'])."\" border=\"0\" width=\"92\" height=\"25\"></a>"	
?>
...
<table cellpadding="<?php echo $cellpadding?$cellpadding:15?>" border=0>
<?php
